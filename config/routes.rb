...
#            list_bulk_update GET    /lists/:list_id/book_list_items/bulk_update(.:format)    book_list_items_bulk_update#show
...
#                             GET    /lists/:list_id/grocery_list_items/bulk_update(.:format) grocery_list_items_bulk_update#show
...
#                             GET    /lists/:list_id/music_list_items/bulk_update(.:format)   music_list_items_bulk_update#show
...
#                             GET    /lists/:list_id/to_do_list_items/bulk_update(.:format)   to_do_list_items_bulk_update#show
