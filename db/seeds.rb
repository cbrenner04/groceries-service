...
book_sample_data = [
  { "author" => "J.R.R. Tolkien", "title" => "The Hobbit", "number_in_series" => "1", "category" => "Fantasy",
    "read" => "false" },
  { "author" => "George R.R. Martin", "title" => "A Game of Thrones", "number_in_series" => "1",
    "category" => "Fantasy", "read" => "true" },
  { "author" => "Patrick Rothfuss", "title" => "The Name of the Wind", "number_in_series" => "1",
    "category" => "Fantasy", "read" => "false" }
]
...
music_sample_data = [
  { "title" => "Bohemian Rhapsody", "artist" => "Queen", "album" => "A Night at the Opera", "category" => "Rock",
    "purchased" => "false" },
  { "title" => "Hotel California", "artist" => "Eagles", "album" => "Hotel California", "category" => "Rock",
    "purchased" => "true" },
  { "title" => "Imagine", "artist" => "John Lennon", "album" => "Imagine", "category" => "Pop", "purchased" => "false" }
]

todo_sample_data = [
  { "task" => "Buy groceries", "assignee_id" => foo.id, "due_by" => "2024-12-25T18:00:00Z", "category" => "Shopping",
    "completed" => "false" },
  { "task" => "Call dentist", "assignee_id" => bar.id, "due_by" => "2024-12-20T17:00:00Z", "category" => "Health",
    "completed" => "true" },
  { "task" => "Review project proposal", "assignee_id" => foo.id, "due_by" => "2024-12-22T16:00:00Z",
