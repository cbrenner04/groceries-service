  ...
  describe "POST /" do
    describe "when type is BookList" do
      it "creates a new list, users_list, and adds new items to the list" do
        ...
        BookListItem.create!(user: user, book_list: first_list, title: "foo", category: "foo")
        BookListItem.create!(user: user, book_list: second_list, title: "bar", category: "bar")
        expect do
    ...
    describe "when type is GroceryList" do
      it "creates a new list, users_list, and adds new items to the list" do
        ...
        GroceryListItem.create!(user: user, grocery_list: first_list, product: "foo", category: "foo")
        GroceryListItem.create!(user: user, grocery_list: second_list, product: "bar", category: "bar")
        expect do
          post merge_lists_path,
               params: { merge_lists: { list_ids: "#{first_list.id},#{second_list.id}", new_list_name: "foobar" } },
               headers: auth_params
    ...
    describe "when type is MusicList" do
      it "creates a new list, users_list, and adds new items to the list" do
        ...
        MusicListItem.create!(user: user, music_list: first_list, title: "foo", category: "foo")
        MusicListItem.create!(user: user, music_list: second_list, title: "bar", category: "bar")
        expect do
          post merge_lists_path,
               params: { merge_lists: { list_ids: "#{first_list.id},#{second_list.id}", new_list_name: "foobar" } },
               headers: auth_params
    ...
    describe "when type is ToDoList" do
      it "creates a new list, users_list, and adds new items to the list" do
        ...
        ToDoListItem.create!(user: user, to_do_list: first_list, task: "foo", category: "foo")
        ToDoListItem.create!(user: user, to_do_list: second_list, task: "bar", category: "bar")
        expect do
          post merge_lists_path,
               params: { merge_lists: { list_ids: "#{first_list.id},#{second_list.id}", new_list_name: "foobar" } },
               headers: auth_params
