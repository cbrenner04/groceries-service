...
RSpec.shared_examples "a list item" do |list_type, required_attrs, item_attrs|
  ...
  describe "GET /:id/edit" do
    describe "with read access" do
      ...
      it "responds with forbidden" do
        get edit_list_v1_list_item_path(list.id, item.id), headers: auth_params
    ...
    describe "with write access" do
      ...
      describe "when item does not exist" do
        it "responds with 404" do
          get edit_list_v1_list_item_path(list.id, "fake_id"), headers: auth_params
  ...
  describe "POST /" do
    describe "with read access" do
      ...
      it "responds with forbidden" do
        post list_v1_list_items_path(list.id),
             params: {
               list_item: {
                 list_id: list.id,
                 user_id: user.id,
    ...
    describe "with write access" do
      ...
      describe "when list does not exist" do
        it "returns 403" do
          post list_v1_list_items_path("fake_id"),
               params: {
                 list_item: {
                   list_id: "fake_id",
                   user_id: user.id,
  ...
  describe "PUT /:id" do
    describe "with read access" do
      ...
      it "responds with forbidden" do
        ...
        put list_v1_list_item_path(list.id, update_item.id),
    ...
    describe "with write access" do
      ...
      describe "when item does not exist" do
        it "returns 404" do
          put list_v1_list_item_path(list.id, "fake_id"),
  ...
  describe "DELETE /:id" do
    describe "with read access" do
      ...
      it "responds with forbidden" do
        ...
        delete list_v1_list_item_path(list.id, delete_item.id), headers: auth_params
    ...
    describe "with write access" do
      ...
      describe "when item does not exist" do
        it "responds with 404" do
          delete list_v1_list_item_path(list.id, "fake_id"), headers: auth_params
